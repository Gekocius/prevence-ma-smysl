...
import { startCreateExamination, changeExaminationState } from '../../services/AdminExaminations/actions';
...
export class AdminExaminationRaw extends Component {
  constructor(props) {
    ...
    this.examPeriodicityBasicRequired = this.examPeriodicityBasicRequired.bind(this);
...
export const AdminExamination = connect(mapStateToProps, mapDispatchToProps)(AdminExaminationRaw);
