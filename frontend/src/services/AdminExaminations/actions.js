...
export const CREATE_EXAMINATION_SUCCESS = 'ADMIN_EXAMS.CREATE_EXAMINATION_SUCCESS';
export const CREATE_EXAMINATION_FAILURE = 'ADMIN_EXAMS.CREATE_EXAMINATION_FAILURE';
